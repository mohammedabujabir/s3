        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
          ...
          .HasForeignKey<PolicemanDecision>(pd => pd.CourtDecisionId);  // المفتاح الأجنبي في قرار الشرطي
           ...
           .HasForeignKey<TrafficViolation>(vs => vs.CourtDecisionId).OnDelete(DeleteBehavior.Restrict);  // المفتاح الأجنبي في حالة المخالفة
            ...
            CitizenUser1.PasswordHash = hasher.HashPassword(CitizenUser1, "Citizen@123");
            ...
            CitizenUser2.PasswordHash = hasher.HashPassword(CitizenUser2, "Citizen@123");
            ...
            PolicmanUser1.PasswordHash = hasher.HashPassword(PolicmanUser1, "Policman@123");
            ...
            PolicmanUser2.PasswordHash = hasher.HashPassword(PolicmanUser2, "Policman@123");
            ...
            JudgeUser1.PasswordHash = hasher.HashPassword(JudgeUser1, "Judge@123");
            ...
            JudgeUser2.PasswordHash = hasher.HashPassword(JudgeUser2, "Judge@123");
